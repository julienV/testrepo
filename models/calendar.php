...
class EventListModelCalendar extends JModel
{
  ...
  var $_date = 0;
	...
	function _buildQuery()
	{
		...
		$query = 'SELECT a.id, a.dates, a.enddates, a.times, a.endtimes, a.title, a.locid, a.datdescription, a.created, l.venue, l.city, l.state, l.url, c.catname, c.id AS catid, c.color, '
