	...
	<div id="eventlist" class="event_id<?php echo $this->row->did; ?> el_details">
		...
		<dl class="event_info floattext">
			...
			<?php elseif ($this->elsettings->showdetlinkclub == 2) : ?>
				...
				<a href="<?php echo sefRelToAbs( 'index.php?option=com_eventlist&amp;Itemid='.$Itemid.'&amp;view=venueevents&amp;locatid='.$this->row->locid ); ?>"><?php echo $this->row->club; ?></a>
			<?php
			...
			<dt class="category"><?php echo JText::_( 'CATEGORY' ).':' ;?></dt>
    			<dd class="category">
					<?php echo "<a href='".sefRelToAbs( 'index.php?option=com_eventlist&amp;Itemid='.$Itemid.'&amp;view=categoryevents&amp;categid='.$this->row->catsid )."'>".$this->row->catname."</a>";?>
				</dd>
		</dl>
  		...
  		<?php echo ELOutput::editbutton($Itemid, $this->row->locid, $this->params, $this->allowedtoeditvenue, 'editvenue' ); ?>
            ...
            <dl class="location floattext">
			 <dt class="club"><?php echo $this->elsettings->locationname.':'; ?></dt>
				<dd class="club">
				<?php echo "<a href='".sefRelToAbs( 'index.php?option=com_eventlist&amp;Itemid='.$Itemid.'&amp;view=venueevents&amp;locatid='.$this->row->locid )."'>".$this->row->club."</a>"; ?>
