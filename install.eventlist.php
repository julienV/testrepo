  ...
  <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
    ...
    <tr>
        ...
        */
		...
		<?php } else {?>
			<font color="red"><b>Joomla! EventList 0.9 ALPHA could NOT be installed successfully!</b></font><br /><br />
			Please check following directories:<br /></code>
			<ul>
			...
			<code>If they do not exist, create them and ensure EventList have write access to this directories.<br />
